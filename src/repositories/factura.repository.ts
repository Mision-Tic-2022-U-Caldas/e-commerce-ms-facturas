...
import {MyqlsDataSource} from '../datasources';
...
> {
  ...
  constructor(
    @inject('datasources.myqls') dataSource: MyqlsDataSource, @repository.getter('ProductoFacturaRepository') protected productoFacturaRepositoryGetter: Getter<ProductoFacturaRepository>,
  ) {
